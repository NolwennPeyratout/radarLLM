...
from lavis.common.annotator.uniformer.mmcv.cnn import ConvModule, build_norm_layer

from lavis.common.annotator.uniformer.mmseg.ops import Encoding, resize
