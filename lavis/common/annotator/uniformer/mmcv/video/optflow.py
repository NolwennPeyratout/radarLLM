...
from lavis.common.annotator.uniformer.mmcv.arraymisc import dequantize, quantize
from lavis.common.annotator.uniformer.mmcv.image import imread, imwrite
from lavis.common.annotator.uniformer.mmcv.utils import is_str
